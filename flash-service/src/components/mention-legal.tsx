    ...
    <div className="fixed inset-0 flex justify-center items-center bg-black bg-opacity-50">
      <div className="bg-white p-6 rounded-md shadow-md w-full max-w-lg">
        ...
        <p>
          Adresse de contact :{" "}
          <a
            href="mailto:flashservice.contactrpi@gmail.com"
            className="text-blue-600"
          >{`flashservice.contactrpi@gmail.com`}</a>
        </p>

        <h2 className="text-lg font-semibold mb-2 mt-4">Hébergement :</h2>
        <p>
          {
            "Flash Service est une application open source sans locaux, hébergée via"
          }{" "}
          <strong>{"Nom du fournisseur d'hébergement"}</strong>.
        </p>
        ...
        <p>
          {
            "Les informations collectées dans l'application sont traitées conformément aux lois sur la protection des données en vigueur. Vous disposez d'un droit d'accès, de rectification et de suppression des informations vous concernant en envoyant un email à : "
          }
          <a
            href="mailto:flashservice.contactrpi@gmail.com"
            className="text-blue-600"
