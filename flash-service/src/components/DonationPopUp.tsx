...
const InfoButton = () => {
  ...
  return (
    <div className="fixed right-6 z-50" style={{ bottom: "5rem" }}>
      <button
        onClick={togglePopup}
        className="flex items-center justify-center w-8 h-8 bg-slate-400 rounded-full"
      >
        <Image
      ...
      {isOpen && (
        ...
        >
          ...
          >
            ...
            <button onClick={togglePopup} className="mt-2 text-blue-500">
              Fermer
            </button>
          </div>
        </div>
