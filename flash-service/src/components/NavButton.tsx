...
const NavButton: FC<IProps> = (props) => {
  ...
  return (
    <div
      className={
        select
          ? " text-black bg-amber-500 w-screen max-h-16 flex justify-center items-center p-2"
          : " bg-slate-900 text-amber-500 w-screen max-h-16 flex justify-center items-center p-2"
      }
    >
